...
{
    public class RemainGroupService
    {
        private static string ToolPath = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot", "tools", "Check Remain Group Tool");
        private static string folderPath = Path.Combine(ToolPath, "CheckList");

        public static List<string> GetFileNames()
        {
            string[] files = Directory.GetFiles(folderPath, "Check*.xlsx");
        ...
        public static ExcelViewModel View_Data(string fileName)
        {
            ...
            List<string> SheetName = new() { "GroupRemain" };
