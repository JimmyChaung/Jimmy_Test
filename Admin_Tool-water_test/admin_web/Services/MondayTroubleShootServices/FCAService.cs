...
namespace admin_web.Services.MondayTroubleShootServices
{
    ...
    {
        private static readonly string ToolPath = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot", "tools", "FCA Tool");
        ...
        public static List<string> GetFileNameList()
        {
            ...
            fileNameList = fileNameList
                .Select(file => file.Replace("fca_", "").Replace(".xlsx", ""))
        ...
        {
            string[] files = Directory.GetFiles(OutputPath, "fca_*.xlsx");
        ...
        {
            string FullFilePath = Path.Combine(OutputPath, $"fca_{FileName}.xlsx");
