...
{
    public class Ticket_systemService
    {
        private static readonly string ToolPath = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot", "tools", "Ticket_system");
        ...
        public static List<string> GetFileNameList()
        {
            ...
            fileNameList = fileNameList
                .Select(file => file.Replace("ticket_system_", "").Replace(".xlsx", ""))
        ...
        {
            string[] files = Directory.GetFiles(OutputPath, "ticket_system_*.xlsx");
        ...
        {
            string FullFilePath = Path.Combine(OutputPath, $"ticket_system_{FileName}.xlsx");
